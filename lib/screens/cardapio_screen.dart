...
class _CardapioScreenState extends State<CardapioScreen> {
  // Função para voltar diretamente para a tela inicial
  void _voltarParaTelaInicial(BuildContext context) {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        // Interceptar o botão físico de voltar
        onWillPop: () async {
          _voltarParaTelaInicial(context);
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () => _voltarParaTelaInicial(context),
            ),
