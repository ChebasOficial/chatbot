...
class YesNoConfirmationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const Color primaryColor = Color.fromARGB(
        255, 255, 255, 255); // Or Colors.cyanAccent[700] or similar

    return Container(
        color: Colors.transparent, // Define o fundo externo como transparente
        child: ClipRRect(
            // O seu ClipRRect existente começa aqui
            borderRadius: BorderRadius.circular(25.0), // Mantém o seu raio
            child: Scaffold(
              ...
              appBar: AppBar(
                ...
                leading: IconButton(
                  ...
                  onPressed: () => Navigator.of(context)
                      .pop(), // Go back to Linha/Coluna Selection
                ),
              ),
              body: SafeArea(
                child: Padding(
