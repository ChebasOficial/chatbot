...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  void _processMessage(String text) {
    ...
    if (lowerText.contains('olá') || lowerText.contains('oi') || lowerText.contains('bom dia') || lowerText.contains('boa tarde')) {
      _addBotMessage('Olá! Como posso ajudar você hoje?');
    } else if (lowerText.contains('cardápio') || lowerText.contains('menu') || lowerText.contains('comida')) {
      _addBotMessage('Aqui está o cardápio de hoje:\n\n'
          ...
          '- Refrigerante\n'
          '- Água');
    } else if (lowerText.contains('horário') || lowerText.contains('funcionamento')) {
      _addBotMessage('Nosso horário de funcionamento é:\n\n'
          '🕐 Segunda a Sexta: 11h às 14h30\n'
          '🕐 Sábado: 11h às 14h\n'
          '🕐 Domingo: Fechado');
    } else if (lowerText.contains('preço') || lowerText.contains('valor') || lowerText.contains('quanto')) {
      _addBotMessage('Nossos preços:\n\n'
          '💰 Prato Executivo: R\$ 15,90\n'
          '💰 Opção Vegetariana: R\$ 14,90\n'
          '💰 Bebidas: R\$ 5,00\n'
          '💰 Sobremesa: R\$ 7,00');
    } else if (lowerText.contains('pedido') || lowerText.contains('pedir') || lowerText.contains('quero')) {
    ...
    } else if (lowerText.contains('confirmar') && _messages.length > 1 && _messages[_messages.length - 2].text.contains('Está correto?')) {
      final pedidoNumero = 10000 + (DateTime.now().millisecondsSinceEpoch % 90000);
      
      _addBotMessage('Pedido confirmado! Seu número de pedido é #$pedidoNumero.\n\n'
          'Resumo do pedido:\n'
      ...
      _addBotMessage('Desculpe, não entendi. Como posso ajudar você? Você pode perguntar sobre nosso cardápio, horário de funcionamento, preços ou fazer um pedido.');
    }
  }
